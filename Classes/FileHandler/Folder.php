 ...
 */
class Folder extends \Kaba\Gallery\ClassMagic\GalleryBaseClass {

	/**
	 * @var \Kaba\Gallery\FileHandler\Validator\File
	 * @inject
	 */
	protected $fileValidator;

	/**
	 * @var \Kaba\Gallery\FileHandler\Validator\Folder
	 * @inject 
	 */
	protected $folderValidator;

	/**
	 * @var \Kaba\Gallery\FileHandler\Validator\FolderContent
	 * @inject
	 */
	 ...
	 * @param bool $relative
	 *
	 * @return \Kaba\Gallery\FileHandler\FolderContent|null
	 * @throws \Exception
	 */
	public function getContentsOfFolder($path, $relative = FALSE) {
		...
		$folderContent = new \Kaba\Gallery\FileHandler\FolderContent($path);
