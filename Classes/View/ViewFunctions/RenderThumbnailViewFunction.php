...
class RenderThumbnailViewFunction extends \Kabarakh\Mirarse\View\ViewFunctions\AbstractViewFunction {
	...
	public function validateParameter() {
		if (!$this->image) {
			throw new \Exception('Property image is needed for renderThumbnail view function', 1371247497);
		}
	}
